...
select
	email,
	birth_date,
	(current_date - birth_date) / 365 as idade_do_cliente -- alias (pseudônimos): para dar nome as colunas calculadas
from sales.customers

select
	email,
	birth_date,
	(current_date - birth_date) / 365 as "idade do cliente" -- aspas duplas para usar espaços no nome da coluna
from sales.customers
