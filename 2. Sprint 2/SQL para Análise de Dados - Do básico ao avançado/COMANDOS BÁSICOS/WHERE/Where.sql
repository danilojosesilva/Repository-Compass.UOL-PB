...
where state = 'SC' -- texto: necessário aspas simples / SQL diferencia letras maiúsculas e minúsculas
...
from sales.customers
where (state = 'SC' or state = 'MS') and birth_date < '1993-02-28' -- ou sem tracinhos '19930228'
